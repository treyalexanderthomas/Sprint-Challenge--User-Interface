...
gives meaning to elements so they're easier to read

2. Name two big differences between ```display: block;``` and ```display: inline;```.
display block: creates line break, aquires full width
inline-block: allows elements to sit next to each other, respects height & width
...
being able to go back to previous models
